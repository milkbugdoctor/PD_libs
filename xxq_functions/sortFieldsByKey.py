...
The purpose is to sort fields in each row according to keys in given order.

License: GNU GPL
Author: Dr. Xiao-Qin Xia

Usage:
	sortFieldsByKey.py  [options]  parameters
...
import os, sys
from basetools import exitMsg, TableFile, InputFile, OutputFile
